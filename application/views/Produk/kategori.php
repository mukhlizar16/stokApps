	...
	<div class="container">
		<div id="tableSimple" class="col-lg-12 layout-spacing layout-top-spacing">
			<div class="action-btn layout-top-spacing mb-3">
				<button id="add-list" class="btn btn-primary" data-toggle="modal" data-target="#kategoriModal">Add
					Kategori
				</button>
			</div>
...
<!-- Modal -->
<div class="modal fade" id="kategoriModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle"
	 aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="btn-simpan" class="float-left btn btn-primary">Simpan</button>
				<button class="btn" data-dismiss="modal"><i class="flaticon-delete-1"></i> Batal</button>
			</div>
		</div>
	</div>
</div>
